...
public class CommandRedPacket implements CommandExecutor {
    ...
    private void helpRedPacket(CommandSender sender) {
        sender.sendMessage(I18n.format("help.redpackets.redpacket"));
        sender.sendMessage(I18n.format("help.redpackets.redpacket_2"));
        sender.sendMessage(I18n.format("help.redpackets.redpacket_3"));
        sender.sendMessage(I18n.format("help.redpackets.redpacket_4"));
        sender.sendMessage(I18n.format("help.redpackets.redpacket_5"));
        sender.sendMessage(I18n.format("help.redpackets.redpacket_6"));
        sender.sendMessage(I18n.format("help.redpackets.redpacket_7"));
    }
}
